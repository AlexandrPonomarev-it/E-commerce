...
def test_smartphone_product_add(product_smartphone_1, product_smartphone_2):
    assert product_smartphone_1.price * product_smartphone_1.quantity + product_smartphone_2.price * product_smartphone_2.quantity == 2580000.0


def test_smartphone_product_add_error(product_smartphone_1):
    with pytest.raises(TypeError):
        assert product_smartphone_1 + 1
